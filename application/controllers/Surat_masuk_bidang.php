...
class surat_masuk_bidang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['surat_masuk'] = $this->db->query("SELECT * FROM surat_masuk WHERE status = 4")->result();


        $this->load->view('templates/header');
        $this->load->view('templates/sidebar');
        $this->load->view('surat_masuk_bidang/index', $data);
    ...
    public function tambah()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebar');
        $this->load->view('surat_masuk_bidang/tambah', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function lihat($id_suratmasuk)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebar');
        $this->load->view('surat_masuk_bidang/lihat', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function lampiran($id_suratmasuk)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebar');
        $this->load->view('surat_masuk_bidang/lampiran', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function file_lampiran($id_lampiran){
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebar');
        $this->load->view('surat_masuk_bidang/lihat_lampiran', $data);
        $this->load->view('templates/footer');
    }
