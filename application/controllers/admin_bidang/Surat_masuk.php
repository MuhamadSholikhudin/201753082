...
class Surat_masuk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['surat_valid'] = $this->db->query("SELECT * FROM surat_masuk JOIN disposisi WHERE surat_masuk.status = 4 AND disposisi.id_user = $id_user ORDER BY id_suratmasuk DESC")->result();
        $data['surat_masuk'] = $this->db->query("SELECT * FROM surat_masuk JOIN disposisi WHERE surat_masuk.status >= 4 AND disposisi.id_user = $id_user ORDER BY id_suratmasuk DESC")->result();
    ...
    public function tambah()
    {
        ...
        $this->load->view('templates/sidebar');
        $this->load->view('admin_bidang/surat_masuk/tambah', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function aksi_tambah()
    {
        ...
        redirect('admin_bidang/surat_masuk/index');
    }
    ...
    public function lampiran($id_suratmasuk)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebar');
        $this->load->view('admin_bidang/surat_masuk/lampiran', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function aksi_tambah_lampiran()
    {
        ...
        redirect('admin_bidang/surat_masuk/lampiran/'. $id_suratmasuk);
    ...
    public function file_lampiran($id_lampiran){
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebar');
        $this->load->view('admin_bidang/surat_masuk/lihat_lampiran', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function kirim($id_suratmasuk){
        ...
        $this->Model_surat_masuk->update_data($where, $data, 'surat_masuk');
        redirect('admin_bidang/surat_masuk/');
