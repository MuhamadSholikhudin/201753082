...
class Persetujuan_surat_keluar extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin_kepala/persetujuan_surat_masuk/index', $data);
    ...
    public function lihat($id_suratkeluar)
    {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar');
        $this->load->view('admin_kepala/persetujuan_surat_masuk/lihat', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function aksi_persetujuan()
    {
        ...
        if ($no < 4) {
            ...
            redirect('admin_kepala/persetujuan_surat_masuk/');
