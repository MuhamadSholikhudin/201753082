...
class Surat_keluar extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin_tu/surat_keluar/index', $data);
    ...
    public function tambah()
    {
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar');
        $this->load->view('admin_tu/surat_keluar/tambah', $data);
        $this->load->view('templates/footer');
    }
...
redirect('admin_tu/surat_keluar');
    ...
    public function aksi_tambah()
    {
        ...
        redirect('admin_tu/surat_keluar/index');
    }
    ...
    public function lampiran($id_suratkeluar)
    {
        ...
        $this->load->view('templates/sidebar');
        $this->load->view('admin_tu/surat_keluar/lampiran', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function aksi_tambah_lampiran()
    {
        ...
        redirect('admin_tu/surat_keluar/lampiran/' . $id_suratkeluar);
    }
    ...
    public function file_lampiran($id_lampiran)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebar');
        $this->load->view('admin_tu/surat_keluar/lihat_lampiran', $data);
        $this->load->view('templates/footer');
    }
