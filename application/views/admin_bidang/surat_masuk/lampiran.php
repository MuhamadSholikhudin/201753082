                ...
                <div class="row">
                    <div class="col-lg-12">
                        <p>
                            ...
                            <a href="<?= base_url('surat_masuk_bidang/') ?>" type="button" class="btn btn-primary">Kembali</a>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($lampiran as $lamp) : ?>
                                                            ...
                                                            <tr class="gradeA odd" role="row">
                                                                ...
                                                                <td class="center">
                                                                    <a href="<?= base_url('surat_masuk_bidang/file_lampiran/') . $lamp->id_lampiran ?>" type="button" class="btn btn-default"><i class="fa fa-file-pdf-o fa-fw"></i>Lihat</a>
