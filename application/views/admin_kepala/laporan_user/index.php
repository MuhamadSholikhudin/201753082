    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <?php
                if ($cetak[0] == 'tanggal') { ?>
                    <a href="<?= base_url('admin_kepala/laporan_user/cetak_user_tanggal/' . $tanggal[0] . '/' . $tanggal[1]) ?>" target="_blank" class="btn btn-warning ">
                ...
                ?>
                    ...
                    <a href="<?= base_url('admin_kepala/laporan_user/cetak_user_bulan/' . $bulan[0] . '/' . $bulan[1]) ?>" target="_blank" class="btn btn-warning ">
                        <i class="fa fa-print"></i>
                        Cetak
                    </a>
                <?php
                ...
                ?>
                    <a href="<?= base_url('admin_kepala/laporan_user/cetak_user_tahun/' . $tahun[0]) ?>" target="_blank" target="_blank" class="btn btn-warning ">
                        <i class="fa fa-print"></i>
                        Cetak
                    </a>
                <?php
