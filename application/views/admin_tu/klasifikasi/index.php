        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        <p>
                            <a href="<?= base_url('admin_tu/klasifikasi/tambah') ?>" class="btn btn-primary ">+ Klasifikasi Surat </a>
                        </p>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($klasifikasi as $kla) : ?>
                                                            <tr class="gradeA odd" role="row">
                                                                ...
                                                                <td class="center">
                                                                    <a href="<?= base_url('admin_tu/klasifikasi/edit/') . $kla->id_klasifikasi ?>" type="button" class="btn btn-warning"><i class="fa fa-edit fa-fw"></i>Edit</a>
                                                                    <a href="<?= base_url('admin_tu/klasifikasi/hapus/') . $kla->id_klasifikasi ?>" type="button" class="btn btn-danger"><i class="fa fa-trash fa-fw"></i>Hapus</a>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
