    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <h3>Pertanggal</h3>
                                <form role="form" action="<?= base_url('admin_tu/laporan_surat_masuk') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-12">
                <?php
                if ($cetak[0] == 'tanggal') { ?>
                    <a href="<?= base_url('admin_tu/laporan_surat_masuk/cetak_surat_masuk_tanggal/' . $tanggal[0] . '/' . $tanggal[1]) ?>" target="_blank" class="btn btn-warning ">
                ...
                ?>
                    ...
                    <a href="<?= base_url('admin_tu/laporan_surat_masuk/cetak_surat_masuk_bulan/' . $bulan[0] . '/' . $bulan[1]) ?>" target="_blank" class="btn btn-warning ">
                        <i class="fa fa-print"></i>
                        Cetak
                    </a>
                <?php
                ...
                ?>
                    <a href="<?= base_url('admin_tu/laporan_surat_masuk/cetak_surat_masuk_tahun/' . $tahun[0]) ?>" target="_blank" target="_blank" class="btn btn-warning ">
                        <i class="fa fa-print"></i>
                        Cetak
                    </a>
                <?php
