        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        <p>
                            <!-- <button href="<?= base_url('admin_tu/surat_keluar/tambah_lampiran') ?>" class="btn btn-primary " >+ Lampiran Surat keluar</button> -->
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form role="form" action="<?= base_url('admin_tu/surat_keluar/aksi_tambah_lampiran') ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <?php foreach ($lampiran as $lamp) : ?>
                                                            ...
                                                            <tr class="gradeA odd" role="row">
                                                                ...
                                                                <td class="center">
                                                                    ...
                                                                    <a href="<?= base_url('admin_tu/surat_keluar/file_lampiran/') . $lamp->id_lampiran ?>" type="button" class="btn btn-default"><i class="fa fa-file-pdf-o fa-fw"></i>Lihat</a>
                                                                    <?php if ($this->session->userdata('hakakses') == 'Admin TU') { ?>
                                                                        <a href="<?= base_url('admin_tu/surat_keluar/edit_lampiran/') . $lamp->id_lampiran ?>" type="button" class="btn btn-warning tampilModalUbah" data-toggle="modal" data-target="#ubahModal" data-id="<?= $lamp->id_lampiran; ?>"><i class="fa fa-edit fa-fw"></i>Edit</a>
                                                                        <div class="modal fade" id="ubahModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form role="form" action="<?= base_url('admin_tu/surat_keluar/aksi_edit_lampiran') ?>" method="post" enctype="multipart/form-data">
                                                                                        <div class="modal-body">
                                                                                            <div class="row">
                                                                                                <div class="col-lg-12">
                                                                                                    <div class="form-group">
                                                                        ...
                                                                        <a href="<?= base_url('admin_tu/surat_keluar/hapus_lampiran/') . $lamp->id_lampiran ?>" type="button" class="btn btn-danger"><i class="fa fa-trash fa-fw"></i>Hapus</a>
