            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form role="form" action="<?= base_url('instansi/aksi_edit') ?>" method="POST" enctype="multipart/form-data">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Nama instansi :</label>
                                        <input class="form-control" type="hidden" name="id_instansi" value="<?= $instansi->id_instansi ?>">
                                        <input class="form-control" type="text" name="nama_instansi" value="<?= $instansi->nama_instansi ?>">
                                        <p class="help-block">Example block-level help text here.</p>
                                    </div>
                                    <div class="form-group">
                                        <label> Alamat :</label>
                                        <input class="form-control" type="text" name="alamat_instansi" value="<?= $instansi->alamat_instansi ?>">
                                    </div>
                                    <div class="form-group">
                                        <label> no_telp :</label>
