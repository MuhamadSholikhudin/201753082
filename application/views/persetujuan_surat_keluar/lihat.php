            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form role="form" action="<?= base_url('persetujuan_surat_keluar/aksi_persetujuan') ?>" method="POST" enctype="multipart/form-data">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label>Index :</label>
                                        <input class="form-control" placeholder="Indeks Surat" type="text" name="index" value="<?= $surat_keluar->index ?>" required disabled>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="panel panel-info">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="hidden" name="id_suratkeluar" value="<?= $surat_keluar->id_suratkeluar ?>" placeholder="Nomer Urut Surat Masuk" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="catatan_disposisi" required><?= $surat_keluar->catatan ?></textarea>
                                                </div>
                                            ...
                                            <div class="panel-footer">
                                                ...
                                                <a href="<?= base_url('validasi_surat_keluar') ?>" class="btn btn-danger ">Batal</a>
                                            </div>
                                        </div>
                                    </div>
