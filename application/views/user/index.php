        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        <p>
                            <a href="<?= base_url('user/tambah') ?>" class="btn btn-primary ">+ user</a>
                        </p>
                                                        ...
                                                        <?php foreach ($user as $peg) : ?>
                                                            <tr class="gradeA odd" role="row">
                                                                ...
                                                                <td class="center">
                                                                    ...
                                                                    <a href="<?= base_url('user/edit/') . $peg->id_user ?>" type="button" class="btn btn-warning"><i class="fa fa-edit fa-fw"></i>Edit</a>
                                                                    <a href="<?= base_url('user/hapus/') . $peg->id_user ?>" type="button" class="btn btn-danger"><i class="fa fa-trash fa-fw"></i>Hapus</a>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
