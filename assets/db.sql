...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Okt 2021 pada 14.24
...
INSERT INTO `disposisi` (`id_disposisi`, `id_suratmasuk`, `tanggal_validasi`, `teruskan_ke`, `catatan`, `harap`, `status`) VALUES
(1, 2, '2021-10-05 06:41:41', 3, 'catatan disposisi', '', 1),
(2, 2, '2021-10-07 09:56:28', 2, 'isi', '', 1);
...
(1, 1, '', '0000-00-00', '', '', '', '', '', '', '0000-00-00', '', '2'),
(2, 3, '12345', '2021-09-30', 'Permohonan', 'Penting', 'isi', 'isi', '12345', 'Layanan', '2021-09-30', 'Umum', '2'),
(3, 1, '', '2021-09-23', '', '', '', '', '', '', '0000-00-00', '', '2'),
(4, 1, '1', '2021-09-30', '', '', '', '', '', '', '0000-00-00', '', '0'),
(5, 1, '1', '2021-09-16', '', '', '', '', '', '', '0000-00-00', '', ''),
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama`, `nip`, `jabatan`, `hakakses`, `foto`) VALUES
(2, 'rahajeng', '123', 'Rahajeng wulansari', '1111888775553', 'Kepala Pelaksana', 'Admin TU', 'ss.JPG'),
(3, 'tarwi', '123', 'Tarwi', '1111888775111', 'Kepala Pelaksana', 'Admin Kepala', 'FOD_Ajeng.jpeg'),
(4, 'ayuk', '123', 'Ayuk Diah', '1111888775553', 'Adm. Bid. Perlengkapan', 'Admin Bidang', 'user.png');
